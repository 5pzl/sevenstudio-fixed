...
const links = [
  { icon: <DownloadCloud className="text-[#fddf4a]" />, title: "Prompts", action: "Download", url: "https://sevenstudio2.gumroad.com/" },
  { icon: <Palette className="text-[#fddf4a]" />, title: "Graphics Packs", action: "Download", url: "https://sevenstudio2.gumroad.com/" },
  { icon: <Video className="text-[#fddf4a]" />, title: "Tutorial", action: "Watch" },
  { icon: <Heart className="text-[#fddf4a]" />, title: "Support", action: "Donate" },
  { icon: <Mail className="text-[#fddf4a]" />, title: "Newsletter", action: "Subscribe" }
];
...
export default function CommandPalette() {
  ...
  return (
    <div className="min-h-screen animated-gradient text-white flex items-center justify-center p-4">
      <div className="w-full max-w-xl bg-[#0f1f1c]/80 backdrop-blur-md custom-glow rounded-2xl border border-[#1a3a34]">
        ...
        <div className="border-t border-[#1a3a34] p-6 flex justify-center">
          <div className="flex gap-6">
            <a href="https://www.instagram.com/sevenstudios_7/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80">
              <Instagram className="w-6 h-6 text-[#fddf4a]" />
            </a>
            <a href="#" className="hover:opacity-80">
              <X className="w-6 h-6 text-[#fddf4a]" />
            </a>
            <a href="mailto:sevenstudio.sev@gmail.com" className="hover:opacity-80">
              <Mail className="w-6 h-6 text-[#fddf4a]" />
            </a>
            <a href="https://www.tiktok.com/@sevenstudios_7" target="_blank" rel="noopener noreferrer" className="hover:opacity-80">
      ...
      <style jsx>{`
        .custom-glow {
          box-shadow: 0 0 35px rgba(0, 160, 127, 0.3), 0 0 80px rgba(253, 223, 74, 0.2);
        }
        .animated-gradient {
